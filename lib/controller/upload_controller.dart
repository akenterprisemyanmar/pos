...
class UploadController extends GetxController {
  ...
  void onInit() {
    ...
    if (!(_homeController.editItem.value == null)) {
      _posController.barcodeController.text = _homeController.editItem.value!.barcode ?? "";
      ...
      _posController.barcodeController.text = "";
    }
  }
  ...
  Future<void> upload() async {
    ...
    try {
      if (form.currentState?.validate() == true) {
          ...
          await _database.update(
            ...
            data: _homeController.editItem.value!
                .copyWith(
                  ...
                  barcode: _posController.barcodeController.text,
                )
                .toJson(),
          );
        } else {
        ...
        filePath.value = '';
        _posController.barcodeController.clear();

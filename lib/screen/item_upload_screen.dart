...
import 'view/pos/controller/pos_controller.dart';
        ...
        child: ListView(
          children: [
            Padding(
              padding: EdgeInsets.only(
                ...
                child: Row(
                  children: [
                    //Leading
                    Text("Scan your product's barcode: "),
                    //Barcode
                    IconButton(onPressed: ()=> Get.to(BarCodeScanner()), 
                    icon: const Icon(
            ...
            Padding(
              ...
              child: TextFormField(
                controller: _posController.barcodeController,
                readOnly: _homeController.editItem.value == null ? false : true,
